...
import { formatDate, parseChip, safeParse, type BetHistoryItem, type BetResult, type TabType } from "../../types";
import styles from "./TabSection.module.css";

interface orderListProp{
loading: boolean
currentData: BetHistoryItem[]
activeTab: TabType
}
const OrderListSection:React.FC<orderListProp> = ({loading,currentData,activeTab}) => {
  return (
              ...
              >
                ...
                <div className={styles.orderHeader}>
                  <div className={styles.orderMeta}>
                    ...
                    <span className={styles.orderDate} style={{textTransform:"uppercase"}}>
